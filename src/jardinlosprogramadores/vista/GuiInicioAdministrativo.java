 ...
 * @author vale_
 */
public class GuiInicioAdministrativo extends javax.swing.JFrame {

    /**
     * Creates new form GuiInicioAdministrativo
     */
    public GuiInicioAdministrativo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnDirector.setBackground(new java.awt.Color(255, 102, 0));
        btnDirector.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        btnDirector.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btnProfesor.setBackground(new java.awt.Color(255, 102, 0));
        btnProfesor.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
    ...
    private void btnDirectorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDirectorActionPerformed
        if (cjId.getText().equals(jardinLosProgramadores.getDirector().getId())) {
            if (cjContrasena.getText().equals(jardinLosProgramadores.getDirector().getContrasena())) {
                GuiInicioDir inicioDir = new GuiInicioDir() {
                    @Override
                    public void dispose() {
                ...
                cjId.setText("");
                inicioDir.setFrameInicio(getFrameA());
                inicioDir.setVisible(true);
    ...
    private void btnProfesorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProfesorActionPerformed
        ...
        for (int i = 0; i < jardinLosProgramadores.getProfesores().size(); i++) {
            if (cjId.getText().equals(jardinLosProgramadores.getProfesores().get(i).getId())) {
                resp = true;
                if (cjContrasena.getText().equals(jardinLosProgramadores.getProfesores().get(i).getContrasena())) {
                    GuiInicioProf inicioProf = new GuiInicioProf() {
                        @Override
                        public void dispose() {
                            getFrameA().setVisible(true);
                            super.dispose();
                    ...
                    inicioProf.setProfesor(jardinLosProgramadores.getProfesores().get(i));
                    inicioProf.setFrameInicio(getFrameA());
                    inicioProf.llenarDatos();
                    inicioProf.setVisible(true);
                    this.setVisible(false);
                } else {
                    alertaCont.setText("La Contraseña es Incorrecta");
                    alertaCont.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiInicioAdministrativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiInicioAdministrativo().setVisible(true);
            }
        });
    }
